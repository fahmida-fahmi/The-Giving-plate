        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <nav>
                    ...
                    <a className="link link-hover">Providers</a>
                    <a className="link link-hover">Consumers</a>
                </nav>
                <nav>
                    <header className="footer-title">more links</header>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>The Giving Plate Ltd. <br />Providing reliable tech since 1992</p>
                </aside>
